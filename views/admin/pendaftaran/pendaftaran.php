     <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Penerimaan Pendaftaran</h3>
            <ol class="breadcrumb">
              <li><i class=""></i><a href="?page=pendaftaran">Penerimaan Pendaftaran</a></li>
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                <label>Penerimaan pendaftaran bagi siswa yang belum mempunyai akun atau belum bergabung ekstrakurikuler.</label>
              <?php
              ...
              <table id="bootstrap-data-table" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="th-sm" style="width: 70px;"><i class=""></i> Status</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                      ...
                      $no = 1;
                      $data = mysqli_query($koneksi,"select * from pendaftaran where status_pendaftaran ='menunggu'");
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-warning" href="?page=verifikasi-pendaftaran&id_pendaftaran=<?php echo $d['id_pendaftaran']; ?>" title="Verifikasi Pendaftaran"><?php echo $d['status_pendaftaran']; ?></a>
                      </div>
                    </td>
                  </tr>
                  <?php 
