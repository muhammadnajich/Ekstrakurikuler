          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <header class="panel-heading">
               <a class="btn btn-primary"  href="?page=add-kelas" title="tambah data kelas"><i class="fa fa-plus"></i> Tambah Kelas</a>
             </header>
             ...
             <table id="bootstrap-data-table" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="btn btn-success" href="?page=edit-kelas&id_kelas=<?php echo $d['id_kelas']; ?>" title="ubah data"><i class="fa fa-pencil-square-o"></i></a>
                      <a class="btn btn-danger" href="?page=delete-kelas&id_kelas=<?php echo $d['id_kelas']; ?>" title="hapus data" onclick="javascript: return confirm('Hapus Data Kelas ?')"><i class="fa fa-trash-o"></i></a>
                    </div>
                  </td>
                </tr>
                <?php 
