      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="form-validate form-horizontal " method="post" action="../../controllers/admin/jadwal/create.php">
                <div class="form-group ">
                  <label for="jadwal" class="control-label col-lg-2">Hari <span class="required">*</span></label>
                  <div class="col-lg-10">
                    <select class="form-control m-bot15" name="hari" title="pilih hari" required="required">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" id="jam_masuk" name="jam_masuk" type="time" title="ketik disini" required="required" />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="jadwal" class="control-label col-lg-2">Jam Keluar<span class="required">*</span></label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="jam_keluar" name="jam_keluar" type="time" title="ketik disini" required="required" />
                  </div>
                </div>                    
                <script>
                  function myFunction() {
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    <button class="btn btn-primary" type="submit" onclick="myFunction()">Simpan</button>
                  </div>
                </div>
              </form>
            </div>
